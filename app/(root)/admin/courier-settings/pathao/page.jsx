...
import { Truck, Save, CheckCircle, AlertCircle } from 'lucide-react'

const breadcrumbData = [
    { href: ADMIN_DASHBOARD, label: 'Home' },
    { href: ADMIN_COURIER_SETTINGS, label: 'Courier Settings' },
    { href: '', label: 'Pathao Courier' },
]
...
export default function PathaoSettingsPage() {
    ...
    const fetchConfig = async () => {
        try {
            const { data } = await axios.get('/api/admin/courier/config/pathao')
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            showToast('success', 'Pathao courier settings saved successfully!')
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center py-20">
                <div className="animate-spin w-10 h-10 border-3 border-red-500 border-t-transparent rounded-full"></div>
            </div>
        )
    }
            ...
            <div className="border rounded-lg overflow-hidden">
                <div className="py-3 px-5 border-b bg-gray-50 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-lg font-bold text-primary">Pathao Courier Settings</h4>
                    </div>
                    {config.isActive ? (
                ...
                <div className="p-5 space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                            <h5 className="font-medium text-gray-800">Enable Pathao Courier</h5>
                    ...
                    <div className="border rounded-lg p-5">
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="https://api.pathao.com/v1"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500"
                                    placeholder="Enter your Pathao API key"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input
                                    ...
                                    className="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500"
                                    placeholder="Enter your Pathao secret key"
                                />
                            </div>
                        </div>
                        <p className="text-sm text-gray-500 mt-3">
                            ...
                            <a 
                                href="https://merchant.pathao.com/developer-api" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="text-red-600 hover:underline"
                            >
                                Pathao Merchant Portal → Developer API
                            </a>
                        </p>
                    </div>
