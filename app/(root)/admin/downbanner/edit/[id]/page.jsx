...
const EditDownBanner = () => {
    ...
    const fetchBannerData = async () => {
        setIsFetching(true)
        try {
            const response = await axios.get(`/api/admin/downbanner/${params.id}`)
    ...
    const onSubmit = async (data) => {
        ...
        setIsLoading(true)
        try {
            const response = await axios.put(`/api/admin/downbanner/${params.id}`, {
                ...data,
        ...
        <div>
            ...
            <Card className="rounded-xl shadow-sm border border-border/60 overflow-hidden gap-0 py-0">
                <CardHeader className="px-5 py-4 border-b bg-muted/30">
                    <h4 className='text-sm font-semibold text-foreground'>Edit Down Banner</h4>
                </CardHeader>
