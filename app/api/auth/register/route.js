...
export async function POST(request) {
    try {
        ...
        await sendMail('Email Verification request from E-Online Fashion Panjabi', email, emailVerificationLink(`${process.env.NEXT_PUBLIC_BASE_URL}/auth/verify-email/${token}`))
