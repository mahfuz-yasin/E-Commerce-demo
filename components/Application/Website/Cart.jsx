                ...
                <div className="h-[calc(100vh-40px)] pb-10 ">
                    <div className="h-[calc(100%-128px)]  overflow-auto px-2">
                        ...
                        {cart.products?.map((product) => (
                            <div key={product.cartItemId} className="flex justify-between items-center gap-5 mb-4 border-b pb-4">
                    ...
                    <div className="h-32 border-t pt-5 px-2">
                        <h2 className="flex justify-between items-center text-lg font-semibold"><span >Subtotal</span> <span>{subtotal?.toLocaleString('en-BD', { style: 'currency', currency: 'BDT' })}</span></h2>
                        <h2 className="flex justify-between items-center text-lg font-semibold"><span >Discount</span> <span>{discount?.toLocaleString('en-BD', { style: 'currency', currency: 'BDT' })}</span></h2>
