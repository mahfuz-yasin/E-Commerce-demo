...
export async function sendFacebookEvent(eventName, customData = {}, userData = {}, eventId = null, options = {}) {
  try {
    ...
    // Hash user data — Advanced Event Match Quality (2025+)
    const hashedUserData = {
      ...
      country: userData.country ? hashSHA256(userData.country || 'BD') : hashSHA256('BD'),
      // Advanced Match Quality fields
      external_id: userData.externalId ? hashSHA256(userData.externalId) : undefined,
      subscription_id: userData.subscriptionId ? hashSHA256(userData.subscriptionId) : undefined,
      lead_id: userData.leadId || undefined,
      // fbc = Facebook Click ID from _fbc cookie (NOT hashed per Meta spec)
      fbc: userData.fbc || undefined,
      // fbp = Facebook Browser ID from _fbp cookie (NOT hashed per Meta spec)
  ...
  while (retryCount < MAX_RETRIES) {
    try {
      ...
      const hashedUserData = {
        ...
        subscription_id: userData.subscriptionId ? hashSHA256(userData.subscriptionId) : undefined,
        lead_id: userData.leadId || undefined,
        // fbc & fbp NOT hashed per Meta spec
        fbc: userData.fbc || undefined,
        fbp: userData.fbp || undefined,
        client_ip_address: userData.ipAddress || undefined,
        client_user_agent: userData.userAgent || undefined,
