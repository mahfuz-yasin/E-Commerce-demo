...
/**
 * Get GA4 Data API access token using OAuth or Service Account
 */
async function getGA4AccessToken() {
  try {
    ...
    // Use OAuth refresh token if available
    ...
    throw new Error('No authentication method configured for GA4 Data API')
  } catch (error) {
