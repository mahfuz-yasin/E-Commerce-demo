 ...
 */
export async function trackTikTokViewContent(productId, productName, price, currency = 'BDT', userData = {}, eventId = null) {
  const eventData = {
 ...
 * @param {string} eventId - Event ID (optional)
 */
export async function trackTikTokAddToCart(productId, productName, price, quantity = 1, currency = 'BDT', userData = {}, eventId = null) {
  const eventData = {
    content_id: [productId],
    content_name: productName,
    content_type: 'product',
 ...
 * @param {string} eventId - Event ID (optional)
 */
export async function trackTikTokInitiateCheckout(value, currency = 'BDT', numItems = 0, userData = {}, eventId = null) {
  const eventData = {
    value: value,
    currency: currency,
    num_items: numItems
 ...
 * @param {string} eventId - Event ID (optional)
 */
export async function trackTikTokPurchase(orderId, value, currency = 'BDT', contentIds = [], userData = {}, eventId = null) {
  const eventData = {
